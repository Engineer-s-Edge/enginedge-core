...
# --- Deleting Secrets ---
[ -f C:\Users\chris\Engineering\EnginEdge\k8s\secrets/postgres-secret.yaml ] && kubectl delete -f C:\Users\chris\Engineering\EnginEdge\k8s\secrets/postgres-secret.yaml --ignore-not-found=true || true
[ -f C:\Users\chris\Engineering\EnginEdge\k8s\secrets/minio-secret.yaml ] && kubectl delete -f C:\Users\chris\Engineering\EnginEdge\k8s\secrets/minio-secret.yaml --ignore-not-found=true || true
